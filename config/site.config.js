...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'xinshan202009@outlook.com',
  ...
  protectedRoutes: ['/images/forumimages/javbus', '/files/study'],
